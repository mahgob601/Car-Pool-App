...
import 'package:car_pool1/Shared/SharedMethods/utils.dart';
            ...
            child: ElevatedButton(
              onPressed: () async {
                try{
                  ...
                  DatabaseReference usereRef = FirebaseDatabase.instance.ref().child("users").child("${user!.uid}");
                  if(tempProfileImage != null)
                    {
                      profileImageURL = await StoreData().uploadImage('users/ProfileImage/${user!.uid}/myImage', tempProfileImage!);
              ...
              style: ElevatedButton.styleFrom(
                ...
                primary: SharedColor.tealColor, // Change the color according to your design
              ),
              child: Text(
                'Update info',
                style: TextStyle(

...
class SharedFont {
  ...
  static final TextStyle subTealStyle = TextStyle(color: Colors.blueGrey, fontSize: 15.0, fontWeight: FontWeight.bold);
  static final TextStyle whiteStyle = TextStyle(color: Colors.white, fontSize: 20.0);
  static final TextStyle appBarTitle = TextStyle(color:Colors.blueGrey, fontSize: 30.0, fontWeight: FontWeight.bold );
}